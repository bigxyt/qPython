...
EXPRESSIONS = OrderedDict((
                    ...
                    (b'(1;`bcd;"0bc";5.5e)',                           [numpy.int64(1), numpy.bytes_('bcd'), b'0bc', numpy.float32(5.5)]),
                    (b'(42;::;`foo)',                                  [numpy.int64(42), None, numpy.bytes_('foo')]),
                    (b'`the`quick`brown`fox',                          qlist(numpy.array([numpy.bytes_('the'), numpy.bytes_('quick'), numpy.bytes_('brown'), numpy.bytes_('fox')], dtype=object), qtype=QSYMBOL_LIST)),
