...
EXPRESSIONS = OrderedDict((
                   ...
                   (b'`abc',                                          numpy.bytes_('abc')),
                   (b'`quickbrownfoxjumpsoveralazydog',               numpy.bytes_('quickbrownfoxjumpsoveralazydog')),
                   (b'0Nh',                                           qnull(QSHORT)),
                   (b'0N',                                            qnull(QLONG)),
                   (b'0Ni',                                           qnull(QINT)),
                   (b'0Nj',                                           qnull(QLONG)),
                   ...
                   (b'(0x01;0x02;0xff)',                              (numpy.array([0x01, 0x02, 0xff]).astype(numpy.byte),
                   ...
                   (b'(1;`bcd;"0bc";5.5e)',                           [numpy.int64(1), numpy.bytes_('bcd'), '0bc', numpy.float32(5.5)]),
                   (b'(42;::;`foo)',                                  [numpy.int64(42), None, numpy.bytes_('foo')]),
                   (b'(1;2h;3.234;"4")',                              [numpy.int64(1), numpy.int16(2), numpy.float64(3.234), '4']),
                   (b'(`one;2 3;"456";(7;8 9))',                      [numpy.bytes_('one'), qlist(numpy.array([2, 3], dtype=numpy.int64), qtype=QLONG_LIST), '456', [numpy.int64(7), qlist(numpy.array([8, 9], dtype=numpy.int64), qtype=QLONG_LIST)]]),

                   (b'`jumps`over`a`lazy`dog',                        (numpy.array(['jumps', 'over', 'a', 'lazy', 'dog'], dtype=numpy.bytes_),
                                                                      qlist(numpy.array(['jumps', 'over', 'a', 'lazy', 'dog']), qtype = QSYMBOL_LIST),
                                                                      qlist(['jumps', 'over', 'a', 'lazy', 'dog'], qtype = QSYMBOL_LIST))),
                   (b'`the`quick`brown`fox',                          numpy.array([numpy.bytes_('the'), numpy.bytes_('quick'), numpy.bytes_('brown'), numpy.bytes_('fox')], dtype=object)),
                   (b'``quick``fox',                                  qlist(numpy.array([qnull(QSYMBOL), numpy.bytes_('quick'), qnull(QSYMBOL), numpy.bytes_('fox')], dtype=object), qtype=QSYMBOL_LIST)),
